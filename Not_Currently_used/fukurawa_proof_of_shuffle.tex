...
\DontPrintSemicolon
    ...
    \myinput{The input list of cryptograms \( \boldsymbol{e} = (e_1, ..., e_n) \in \mathbb{E}^n \)}
    \myinput{The list of randomizers \( \boldsymbol{r'} = (r'_1, ..., r'_n) \in \mathbb{Z}_q^n \)}
...
\DontPrintSemicolon
    ...
    \KwData{The encryption key \( Y \in E(\mathbb{F}_p) \)}
    \myinput{The input list of cryptograms \( \boldsymbol{e} = (e_1, ..., e_n) \in \mathbb{E}^n \)}
    \myinput{\( e_i = (R_i, C_i) \), where \( i \in \{ 1, ..., n \} \)}
    \myinput{The list of randomizers \( \boldsymbol{r'} = (r'_1, ..., r'_n) \in \mathbb{Z}_q^n \)}
    \myinput{The permutation \( \psi \in \Psi_n \) }
    \myinput{Scalars \( \sigma, \rho, \tau, \lambda, a, \in \mathbb{Z}_q \) and \( \boldsymbol{\alpha} = (\alpha_1, ..., \alpha_n), \boldsymbol{\lambda} = (\lambda_1, ..., \lambda_n) \in \mathbb{Z}_q^n \)}
    % \myinput{Scalars \( \boldsymbol{\alpha} = (\alpha_1, ..., \alpha_n), \boldsymbol{\lambda} = (\lambda_1, ..., \lambda_n) \in \mathbb{Z}_q^n \)}
...
\DontPrintSemicolon
    ...
    \myinput{The permutation \( \psi \in \Psi_n \) }
    \myinput{Scalars \( \lambda, a \in \mathbb{Z}_q \) and \( \boldsymbol{\alpha} = (\alpha_1, ..., \alpha_n), \boldsymbol{\lambda} = (\lambda_1, ..., \lambda_n) \in \mathbb{Z}_q^n \)}
    % \myinput{Scalars \( \boldsymbol{\alpha} = (\alpha_1, ..., \alpha_n), \boldsymbol{\lambda} = (\lambda_1, ..., \lambda_n) \in \mathbb{Z}_q^n \)}
    \myinput{The list of challenges \( \boldsymbol{c} = (c_1, ..., c_n) \in \mathbb{Z}_q^n \)}
...
\DontPrintSemicolon
    ...
    \KwData{The encryption key \( Y \in E(\mathbb{F}_p) \)}
    \myinput{The proof of shuffle \( PK = (\boldsymbol{K}, \boldsymbol{c}, \boldsymbol{r}) \)}
    \myinput{\( \boldsymbol{K} = (R', C', U, \boldsymbol{U}, T, \boldsymbol{\dot{T}}, V, \boldsymbol{\dot{V}}, \dot{V}, W, \boldsymbol{\dot{W}}, \dot{W}) \in E(\mathbb{F}_p)^{8 + 4 \cdot n} \)}
    \myinput{\( \boldsymbol{U} = (U_1, ..., U_n), \boldsymbol{\dot{T}} = (\dot{T}_1, ..., \dot{T}_n) \in E(\mathbb{F}_p)^n \)}
    \myinput{\( \boldsymbol{\dot{V}} = (\dot{V}_1, ..., \dot{V}_n), \boldsymbol{\dot{W}} = (\dot{W}_1, ..., \dot{W}_n) \in E(\mathbb{F}_p)^n \)}
    \myinput{\( \boldsymbol{c} = (c_1, ..., c_n) \in \mathbb{Z}_q^n \)}
    \myinput{\( \boldsymbol{r} = (\lambda', z, \boldsymbol{s}) \in \mathbb{Z}_q^{2 + n} \)}
    \myinput{\( \boldsymbol{s} = (s_1, ..., s_n) \in \mathbb{Z}_q^n \)}
    \myinput{The input list of cryptograms \( \boldsymbol{e} = (e_1, ..., e_n) \in \mathbb{E}^n \)}
    \myinput{\( e_i = (R_i, C_i) \), with \( i \in \{ 1, ..., n \} \)}
    \myinput{The output list of cryptograms \( \boldsymbol{e'} = (e'_1, ..., e'_n) \in \mathbb{E}^n \)}
    \myinput{\( e'_i = (R'_i, C'_i) \), with \( i \in \{ 1, ..., n \} \)}
...
\DontPrintSemicolon
    ...
    \myinput{The output list of cryptograms \( \boldsymbol{e'} = (e'_1, ..., e'_n) \in \mathbb{E}^n \)}
    \myinput{The commitment of the proof \( \boldsymbol{K} \in E(\mathbb{F}_p)^{8 + 4 \cdot n} \)}
...
\DontPrintSemicolon
    ...
    \KwData{The encryption key \( Y \in E(\mathbb{F}_p) \)}
    \myinput{The proof of shuffle \( PK = (\boldsymbol{K}, \boldsymbol{c}, \boldsymbol{r}) \in E(\mathbb{F}_p)^{8 + 4 \cdot n} \times \mathbb{Z}_q^n \times \mathbb{Z}_q^{2 + n} \)}
    \myinput{The input list of cryptograms \( \boldsymbol{e} = (e_1, ..., e_n) \in \mathbb{E}^n \)}
    \myinput{The output list of cryptograms \( \boldsymbol{e'} = (e'_1, ..., e'_n) \in \mathbb{E}^n \)}
...
\DontPrintSemicolon
    ...
    \KwData{The encryption key \( Y \in E(\mathbb{F}_p) \)}
    \myinput{The input matrix of cryptograms \( \boldsymbol{e} = (e_{1, 1}, ..., e_{n, m}) \in \mathbb{E}^{n \cdot m} \)}
    \myinput{The matrix of randomizers \( \boldsymbol{r'} = (r'_{1, 1}, ..., r'_{n, m}) \in \mathbb{Z}_q^{n \cdot m} \)}
    \myinput{The permutation \( \psi \in \Psi_n \)}
    \For{\( i \gets 1 \) \KwTo $n$ \KwBy $1$ }{
...
\DontPrintSemicolon
    ...
    \KwData{The encryption key \( Y \in E(\mathbb{F}_p) \)}
    \myinput{The input matrix of cryptograms \( \boldsymbol{e} = (e_{1, 1}, ..., e_{n, m}) \in \mathbb{E}^{n \cdot m} \)}
    \myinput{\( e_{i, j} = (R_{i, j}, C_{i, j}) \), where \( i \in \{ 1, ..., n \}, j \in \{ 1, ..., m \} \)}
    \myinput{Scalars \( \sigma, \rho, \tau, \lambda \in \mathbb{Z}_q \)}
    \myinput{Scalars \( \boldsymbol{a} = (a_1, ..., a_m) \in \mathbb{Z}_q^m \)}
    \myinput{Scalars \( \boldsymbol{\alpha} = (\alpha_1, ..., \alpha_n), \boldsymbol{\lambda} = (\lambda_1, ..., \lambda_n) \in \mathbb{Z}_q^n \)}
...
\DontPrintSemicolon
    ...
    \myinput{The permutation \( \psi \in \Psi_n \)}
    \myinput{Scalar \( \lambda \in \mathbb{Z}_q \)}
    \myinput{Scalars \( \boldsymbol{a} = (a_1, ..., a_m) \in \mathbb{Z}_q^m \)}
    \myinput{Scalars \( \boldsymbol{\alpha} = (\alpha_1, ..., \alpha_n), \boldsymbol{\lambda} = (\lambda_1, ..., \lambda_n) \in \mathbb{Z}_q^n \)}
    \myinput{The list of challenges \( \boldsymbol{c} = (c_1, ..., c_n) \in \mathbb{Z}_q^n \)}
    \( \lambda' \gets \sum_{i=1}^n \lambda_i \cdot c_i^2 + \lambda \pmod q \) \\
...
\DontPrintSemicolon
    ...
    \KwData{The encryption key \( Y \in E(\mathbb{F}_p) \)}
    \myinput{The proof of shuffle \( PK = (\boldsymbol{K}, \boldsymbol{c}, \boldsymbol{r}) \)}
    \myinput{\( \boldsymbol{K} = (\boldsymbol{R'}, \boldsymbol{C'}, U, \boldsymbol{U}, T, \boldsymbol{\dot{T}}, V, \boldsymbol{\dot{V}}, \dot{V}, W, \boldsymbol{\dot{W}}, \dot{W}) \in E(\mathbb{F}_p)^{6 + 2 \cdot m + 4 \cdot n} \)}
    \myinput{\( \boldsymbol{R'} = (R'_1, ..., R'_m), \boldsymbol{C'} = (C'_1, ..., C'_m) \in E(\mathbb{F}_p)^m \)}
    \myinput{\( \boldsymbol{U} = (U_1, ..., U_n), \boldsymbol{\dot{T}} = (\dot{T}_1, ..., \dot{T}_n) \in E(\mathbb{F}_p)^n \)}
    \myinput{\( \boldsymbol{\dot{V}} = (\dot{V}_1, ..., \dot{V}_n), \boldsymbol{\dot{W}} = (\dot{W}_1, ..., \dot{W}_n) \in E(\mathbb{F}_p)^n \)}
    \myinput{\( \boldsymbol{c} = (c_1, ..., c_n) \in \mathbb{Z}_q^n \)}
    \myinput{\( \boldsymbol{r} = (\lambda', \boldsymbol{z}, \boldsymbol{s}) \in \mathbb{Z}_q^{1 + m + n} \)}
    \myinput{\( \boldsymbol{z} = (z_1, ..., z_m) \in \mathbb{Z}_q^m \)}
    \myinput{\( \boldsymbol{s} = (s_1, ..., s_n) \in \mathbb{Z}_q^n \)}
    \myinput{The input matrix of cryptograms \( \boldsymbol{e} = (e_{1, 1}, ..., e_{n, m}) \in \mathbb{E}^{n \cdot m} \)}
    \myinput{\( e_{i, j} = (R_{i, j}, C_{i, j}) \), with \( i \in \{ 1, ..., n \}, j \in \{ 1, ..., m \} \)}
    \myinput{The output matrix of cryptograms \( \boldsymbol{e'} = (e'_{1, 1}, ..., e'_{n, m}) \in \mathbb{E}^{n \cdot m} \)}
    \myinput{\( e'_{i, j} = (R'_{i, j}, C'_{i, j}) \), with \( i \in \{ 1, ..., n \}, j \in \{ 1, ..., m \} \)}
    \eIf{\( [\lambda']G = U + \sum_{i=1}^n [c_i^2]U_i \) \\
...
\DontPrintSemicolon
    ...
    \KwData{The encryption key \( Y \in E(\mathbb{F}_p) \)}
    \myinput{The proof \( PK = (\boldsymbol{K}, \boldsymbol{c}, \boldsymbol{r}) \in E(\mathbb{F}_p)^{6 + 2 \cdot m + 4 \cdot n} \times \mathbb{Z}_q^n \times \mathbb{Z}_q^{1 + m + n} \)}
    \myinput{The input matrix of cryptograms \( \boldsymbol{e} = (e_{1, 1}, ..., e_{n, m}) \in \mathbb{E}^{n \cdot m} \)}
    \myinput{The output matrix of cryptograms \( \boldsymbol{e'} = (e'_{1, 1}, ..., e'_{n, m}) \in \mathbb{E}^{n \cdot m} \)}
    \eIf{\( \boldsymbol{c} = \mathbf{ShuffleChall} (\boldsymbol{e}, \boldsymbol{e'}, \boldsymbol{K}) \) \tcp*{algorithm \ref{alg: shuffle challenge}}
