...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        \node[arrow, towards_right, after_arrow, between={p.center}{v.center}, anchor=south west] at (p_1.south -| p.center) (a_1) {
            \hspace{80pt} $K$
            };
        \node[block, after_arrow, keep_middle] at (a_1.south -| v.center) (v_1) {
        ...
        \node[block, after_arrow, keep_middle] at (a_2.south -| p.center) (p_2) {
            $r \gets k + c \cdot x \pmod q$
            };
        \node[arrow, towards_right, after_arrow, between={p.center}{v.center}, anchor=south west] at (p_2.south -| p.center) (a_3) {
            $r$
            };
        \node[block, after_arrow, keep_right] at (a_3.south -| v.east) (v_2) {
