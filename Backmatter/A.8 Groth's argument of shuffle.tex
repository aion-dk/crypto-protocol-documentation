...
\begin{algorithm}[ht]
    \DontPrintSemicolon
    \caption{$\mathsf{ASKCVer}(AS; \boldsymbol{m}; C)$}
    \label{alg: askc ver}
...
\begin{algorithm}[ht]
    \DontPrintSemicolon
    \caption{$\mathsf{MixProve}(\psi, Y, \boldsymbol{r}, \boldsymbol{e}, \boldsymbol{e'})$}
    \label{alg: mix prove}
    \KwData{The permutation $\psi \in \Psi_n$}
    ...
    $AS \gets \mathsf{ASKCProve}(\psi; r'; \boldsymbol{m'}; C')$ \tcp*{\cref{alg: askc prove}}
...
\begin{algorithm}[ht]
    \DontPrintSemicolon
    \caption{$\mathsf{MixVer}(PM, AS, Y, \boldsymbol{e}, \boldsymbol{e'})$}
    \label{alg: mix ver}
    ...
    \KwAnd $\mathsf{ASKCVer}(AS; \boldsymbol{m}; C')$ \tcp*{\cref{alg: askc ver}}}{
