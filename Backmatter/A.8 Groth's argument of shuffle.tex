...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        %All content
        \node[block, keep_middle, first] at (p_ik.south -| v.center) (v_1) {
            $x \in_\mathrm{R} \mathbb{Z}_q$ \hspace{10pt}
            };
        \node[arrow, towards_left, after_arrow, between={p.center}{v.center}, anchor=south east] at (v_1.south -| v.center) (a_1) {
            $x$
            };
        \node[block, keep_left, after_arrow] at (a_1.south -| p.west) (p_1) {
        ...
        \node[block, keep_middle, after_arrow] at (a_2.south -| v.center) (v_2) {
            $e \in_\mathrm{R} \mathbb{Z}_q$
            };
        \node[arrow, towards_left, after_arrow, between={p.center}{v.center}, anchor=south east] at (v_2.south -| v.center) (a_3) {
            $e$ \hspace{10pt}
            };
        \node[block, keep_left, after_arrow] at (a_3.south -| p.west) (p_2) {
        ...
        \node[block, keep_right, after_arrow] at (a_4.south -| v.east) (v_3) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        % Actors
        \node[title, text width=197, above, anchor=north east] (p) {
            \textbf{Prover}};
        \node[title, text width=123, right=of p] (v) {
            \textbf{Verifier}};
        
        % internal knowledge
        \node[internal, text width=197, below=of p] (p_ik) {
        ...
        \node[internal, text width=123, below=of v] (v_ik) {
        ...
        \node[block, keep_middle, after_arrow] at (a_1.south -| v.center) (v_1) {
            $\boldsymbol{t} = \{t_1, ..., t_n\} \in_\mathrm{R} \mathbb{Z}_q^n$
            };
        \node[arrow, towards_left, after_arrow, between={p.center}{v.center}, anchor=south east] at (v_1.south -| v.center) (a_2) {
            $\boldsymbol{t} = \{t_1, ..., t_n\}$ \hspace{30pt}
            };
        \node[block, keep_left, after_arrow] at (a_2.south -| p.west) (p_2) {
        ...
        \node[block, keep_middle, after_arrow] at (a_3.south -| v.center) (v_2) {
            $\lambda \in_\mathrm{R} \mathbb{Z}_q$
            };
        \node[arrow, towards_left, after_arrow, between={p.center}{v.center}, anchor=south east] at (v_2.south -| v.center) (a_4) {
            $\lambda$ \hspace{10pt}
            };
        \node[banner, keep_left, after_arrow, between={p.west}{v.east}] at (a_4.south -| p.west) (b_1) {
        ...
        \node[block, keep_right, after_arrow] at (b_1.south -| v.east) (v_3) {
        ...
        % Arrows and lines
        \draw[dashed] (p.south west)--(v.south east);    
        \draw[dashed] (p_ik.south west)--(v_ik.south east);
