...
\begin{algorithm}[ht]
    ...
    \KwAnd $[e]C_\mathrm{a} + C_\delta = \mathsf{Com}(\vec{f}\,'; z_\delta)$ \\
...
\begin{algorithm}[ht]
    ...
    $C' \gets [\lambda]C + C_\mathrm{d} + \mathsf{Com}(\vec{f}; 0)$ \;
    $\vec{m} \gets \{ m_1, ..., m_n \}$ \tcp*{\cref{alg: com}}
    ...
    \KwAnd $\mathsf{ASKCVer}(AS; \vec{m}; C')$ \tcp*{\cref{alg: askc ver}}}{
