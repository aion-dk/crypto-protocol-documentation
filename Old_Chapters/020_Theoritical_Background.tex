...
\DontPrintSemicolon
    ...
    \KwMoreData{The private key \( x \in \mathbb{Z}_q \)}
...
\DontPrintSemicolon
    ...
    \KwData{The base generator \( G \in E(\mathbb{F}_p) \)}
    \KwMoreData{The proof \( PK = (K, c, r) \in E(\mathbb{F}_p) \times \mathbb{Z}_q \times \mathbb{Z}_q \)}
    \KwMoreData{The public key \( Y \in E(\mathbb{F}_p) \)}
...
\DontPrintSemicolon
    ...
    \KwMoreData{The second base generator \( H \in E(\mathbb{F}_p) \)}
    \KwMoreData{The private key \( x \in \mathbb{Z}_q \)}
    \( k \in_\mathrm{R} \mathbb{Z}_q \)\;
    \( K_\mathrm{G} \gets [k]G \)\;
    \( K_\mathrm{H} \gets [k]H \)\;
...
\DontPrintSemicolon
    ...
    \KwData{The first base generator \( G \in E(\mathbb{F}_p) \)}
    \KwMoreData{The second base generator \( H \in E(\mathbb{F}_p) \)}
    \KwMoreData{The proof \( PK = (\boldsymbol{K}, c, r) \in E(\mathbb{F}_p)^2 \times \mathbb{Z}_q \times \mathbb{Z}_q \)}
    \KwMoreData{The first public key \( Y \in E(\mathbb{F}_p) \)}
    \KwMoreData{The second public key \( P \in E(\mathbb{F}_p) \)}
...
\DontPrintSemicolon
    ...
    \KwData{The list of generators \( \boldsymbol{G} = (G_0, G_1, ..., G_n) \in E(\mathbb{F}_p)^{n+1} \)}
    \KwMoreData{The proof \( PK = (K, c, r) \in E(\mathbb{F}_p) \times \mathbb{Z}_q \times \mathbb{Z}_q \)}
    \KwMoreData{The list of public keys \( \boldsymbol{Y} = (Y_0, Y_1, ..., Y_n) \in E(\mathbb{F}_p)^{n+1} \)}
    \( h \gets \mathcal{H} (Y_1 || ... || Y_n) \)\;
    \For{\( i \gets 1 \) \KwTo $n$ \KwBy $1$}{
        \( z_i \gets \mathcal{H} (i || h) \)}
...
\DontPrintSemicolon
    ...
    \KwMoreData{The message \( M \in E(\mathbb{F}_p) \)}
...
\DontPrintSemicolon
    ...
    \KwData{The encryption key \( Y \in E(\mathbb{F}_p) \)}
    \KwMoreData{The message \( m \in \mathbb{Z}_q \)}
    \KwMoreData{The randomizer \( r \in \mathbb{Z}_q \)}
    \( R \gets [r]G \)\;
    \( S \gets [r]Y \)\;
    \( s \gets \mathcal{H} (S) \)\;
...
\DontPrintSemicolon
    ...
    \KwData{The decryption key \( x \in \mathbb{Z}_q \)}
    \KwMoreData{The cryptogram \( e = (R, c) \in E(\mathbb{F}_p) \times \mathbb{Z}_q \)}
    \( S \gets [x]R \)\;
    \( s \gets \mathcal{H} (S) \)\;
