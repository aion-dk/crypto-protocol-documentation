...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed,
        ...
        % All content
        \node[arrow, towards_right, first, between={v.center}{ip.center}] at (v_ik.south -| v.center) (a_1) {
            authenticate as $\mathcal{V}_i$
            };
        \node[block, keep_middle, after_arrow] at (a_1.south -| ip.center) (ip_1) {
            $\sigma_{\mathrm{id}, j} \gets \mathsf{Sign}(x_{\mathcal{I}_j}; \mathcal{V}_i)$
            };
        \node[arrow, towards_left, after_arrow, between={v.center}{ip.center}, anchor=south east] at (ip_1.south -| ip.center) (a_2) {
            $\sigma_{\mathrm{id}, j}$
            };
        \node[block, keep_left, after_arrow] at (a_2.south -| v.west) (v_1) {
            verify that $\mathsf{SigVer}(Y_{\mathcal{I}_j}, \sigma_{\mathrm{id}, j}; \mathcal{V}_i)$
            };
        \node[banner, keep_left, after_arrow, between={v.west}{ip.east}] at (v_1.south -| v.west) (b_1) {
        ...
        \node[block, keep_middle, after_arrow] at (b_1.south -| v.center) (v_2) {
            $(x_i, Y_i) \gets \mathsf{KeyGen}()$
            };
        \node[arrow, towards_right, after_arrow, between={v.center}{va.center}, anchor=south west] at (v_2.south -| v.center) (a_3) {
            \hspace{30pt} $Y_i, \{ \sigma_{\mathrm{id}, 1}, ..., \sigma_{\mathrm{id}, n_\mathrm{i}} \}$
            };
        \node[block, keep_left, after_arrow] at (a_3.south -| va.west) (va_1) {
        ...
        \node[arrow, towards_left, after_arrow, between={v.center}{va.center}, anchor=south east] at (va_1.south -| va.center) (a_4) {
            $b_\mathrm{vs}$ \hspace{70pt}
            };
        \node[block, keep_left, after_arrow] at (a_4.south -| v.west) (v_3) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed,
        ...
        %All content
        \node[block, keep_left, first] at (dbb_ik.south -| v_ik.west) (v_1) {
        ...
        \node[banner, keep_left, after_arrow, between={v.west}{dbb.east}] at (v_1.south west) (b_1) {
        ...
        \node[block, keep_right, after_arrow] at (b_1.south east) (dbb_1) {
        ...
        \node[arrow, towards_left, between={v.center}{dbb.center}, anchor=north west] at (dbb_1.south -| v.center) (a_1) {
            $(b_\mathrm{vec}, \rho_\mathrm{vec})$, $(b_\mathrm{sec}, \rho_\mathrm{sec})$, $e_\mathrm{d}$
            };
        \node[block, keep_left, after_arrow] at (a_1.south -| v.west) (v_2) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed,
        ...
        %All content
        \node[block, first, keep_left] at (v_ik.south west) (v_1) {
        ...
        \node[arrow, towards_right, after_arrow, anchor=south west, between={v.center}{dbb.center}] at (v_1.south -| v.center) (a_1) {
            \hspace{40pt} $e = (R, C)$, $PK$
            };
        \node[block, keep_right, after_arrow] at (a_1.south -| dbb.east) (dbb_1) {
            verify that $\mathsf{DLVer}(PK, \{ G \}; \{ R - [r_\mathrm{d}]G \})$
            };
        \node[banner, keep_left, after_arrow, between={v.west}{dbb.east}] at (dbb_1.south -| v.west) (b_1) {
        ...
        \node[block, keep_right, after_arrow] at (b_1.south east) (dbb_2) {
        ...
        \node[arrow, towards_left, between={v.center}{dbb.center}] at (dbb_2.south -| dbb.center) (a_2) {
            $(b_\mathrm{bc}, \rho_\mathrm{bc})$, $(b_\mathrm{vts}, \rho_\mathrm{vts})$
            };
        \node[block, keep_left, after_arrow] at (a_2.south -| v.west) (v_2) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        % All content
        \node[arrow, towards_right, first, between={v.center}{ev.center}] at (dbb_ik.south -| v.center) (a_1) {
            address of $b_\mathrm{vts}$
            };
        \node[arrow, towards_right, between={ev.center}{dbb.center}, after_arrow] at (a_1.north -| ev.center) (a_2) {
            address of $b_\mathrm{vts}$
            };
        \node[arrow, towards_left, after_arrow, between={ev.center}{dbb.center}] at (a_2.south -| dbb.center) (a_3) {
            $\alpha_\mathrm{vts} = \alpha_\mathrm{cnf} \cup \{ b_\mathrm{vs}, b_\mathrm{vec}, b_\mathrm{sec}, b_\mathrm{bc}, b_\mathrm{vts} \}$
            };
        \node[block, keep_left, after_arrow] at (a_3.south -| ev.west) (ev_1) {
        ...
        \node[arrow, towards_left, after_arrow, between={v.center}{ev.center}, anchor=south east] at (ev_1.south -| ev.center) (a_4) {
            "ballot found" \hspace{60pt}
            };
        \node[block, keep_left, after_arrow] at (a_4.south -| v.west) (v_1) {
            $m_\mathrm{sr} \gets $ "spoil request", $c_\mathrm{sr} \gets \varnothing$, $p_\mathrm{sr} \gets$ address of $b_\mathrm{bc}$
            };
        \node[banner, keep_left, after_arrow, between={v.west}{dbb.east}] at (v_1.south -| v.west) (b_1) {
        ...
        \node[arrow, towards_left, between={ev.center}{dbb.center}] at (b_1.south -| dbb.center) (a_5) {
            $b_\mathrm{sr}$
            };
        \node[block, keep_left, after_arrow] at (a_5.south -| ev.west) (ev_2) {
        ...
        \node[banner, keep_left, after_arrow, between={ev.west}{dbb.east}] at (ev_2.south -| ev.west) (b_2) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        % All content
        \node[arrow, first, towards_left, between={v.center}{ev.center}] at (v_ik.south -| ev.center) (a_1) {
            $h_\mathrm{v} = $ address of $b_\mathrm{v}$
            };
        \node[arrow, towards_left, after_arrow, between={v.center}{dbb.center}] at (a_1.north -| dbb.center) (a_2) {
        ...
        \node[arrow, towards_left, after_arrow, between={v.center}{dbb.center}, anchor=south east] at (dbb_1.south -| dbb.center) (a_3) {
            $b_\mathrm{vco}$, $b_\mathrm{sco}$ \hspace{100pt}
            };
        \node[block, keep_left, after_arrow] at (a_3.south -| v.west) (v_2) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        % All content
        \node[arrow, first, towards_left, between={ev.center}{dbb.center}, anchor=north west] at (dbb_ik.south -| ev.center) (a_1) {
            $b_\mathrm{vco}$, $b_\mathrm{sco}$
            };
        \node[block, keep_middle, after_arrow] at (a_1.south -| ev.center) (ev_1) {
        ...
        \node[arrow, towards_left, between={v.center}{ev.center}] at (ev_1.south -| ev.center) (a_2) {
            $V'$
            };
        \node[block, keep_middle, after_arrow] at (a_2.south -| v.center) (v_1) {
            verify that $V = V'$
            };
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        %All content
        \node[block, keep_left, first] at (dbb_ik.south -| v.west) (v_1) {
        ...
        \node[block, keep_left, after_arrow] at (b_1.south -| v.west) (v_2) {
