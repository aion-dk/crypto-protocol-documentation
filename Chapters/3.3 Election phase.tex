...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed,
        ...
        \node[process_v2, keep_left, after_arrow] at (a_3.south -| va.west) (va_1) {
            ...
            $m_\mathrm{vs} \gets$ "voter session", $p_\mathrm{vs} \gets$ the address of the latest item from $\alpha_\mathrm{cnf}$ \\ [5pt]
            ...
            \scriptsize $(b_\mathrm{vs}, \rho_\mathrm{vs}) \gets \mathtt{WriteOnBoard}(\mathcal{A}, m_\mathrm{vs}, c_\mathrm{vs}, p_\mathrm{vs})$ \\ [5pt]
