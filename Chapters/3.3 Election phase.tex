...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        % All content
        \node[arrow, towards_left, first, between={v.center}{ev.center}] at (v_ik.south -| v.center) (a_1) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        % All content
        \node[arrow, towards_left, first, between={ev.center}{dbb.center}] at (dbb_ik.south -| ev.center) (a_1) {
