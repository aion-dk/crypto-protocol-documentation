...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed,
        ...
        % All content
        \node[arrow_v2, towards_right, first, between={v.center}{ip.center}] at (v_ik.south -| v.center) (a_1) {
        ...
        \node[arrow_v2, towards_left, after_arrow, between={v.center}{ip.center}, anchor=south east] at (ip_1.south -| ip.center) (a_2) {
            $\sigma_{\mathrm{id}, j}$
            };
        ...
        \node[arrow_v2, towards_right, after_arrow, between={v.center}{va.center}, anchor=south west] at (v_2.south -| v.center) (a_3) {
        ...
        \node[arrow_v2, towards_left, after_arrow, between={v.center}{va.center}, anchor=south east] at (va_1.south -| va.center) (a_4) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed,
        ...
        \node[arrow_v2, towards_right, after_arrow, anchor=south west, between={v.center}{dbb.center}] at (v_1.south -| v.center) (a_1) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        % All content
        \node[arrow_v2, towards_right, first, between={v.center}{ev.center}] at (dbb_ik.south -| v.center) (a_1) {
        ...
        \node[arrow_v2, towards_left, after_arrow, between={v.center}{ev.center}, anchor=south east] at (ev_1.south -| ev.center) (a_4) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        \node[arrow_v2, towards_left, after_arrow, between={v.center}{dbb.center}] at (a_1.north -| dbb.center) (a_2) {
        ...
        \node[arrow_v2, towards_left, after_arrow, between={v.center}{dbb.center}, anchor=south east] at (dbb_1.south -| dbb.center) (a_3) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        %All content
        \node[process_v2, keep_left, first] at (dbb_ik.south -| v.west) (v_1) {
        ...
        \node[process_v2, keep_left, after_arrow] at (b_1.south -| v.west) (v_2) {
