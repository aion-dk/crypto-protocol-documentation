...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        \node[arrow_v2, towards_left, after_arrow, between={ev.center}{dbb.center}] at (a_2.south -| dbb.center) (a_3) {
            $\alpha_\mathrm{vts} = \alpha_\mathrm{cnf} \cup \{ b_\mathrm{vs}, b_\mathrm{vec}, b_\mathrm{sec}, b_\mathrm{bc}, b_\mathrm{vts} \}$
            };
        \node[process_v2, keep_left, after_arrow] at (a_3.south -| ev.west) (ev_1) {
        ...
        \node[process_v2, keep_left, after_arrow] at (a_4.south -| v.west) (v_1) {
        ...
        \node[process_v2, keep_left, after_arrow] at (a_5.south -| ev.west) (ev_2) {
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        \draw[densely dotted] (dbb_ik.south -| dbb.center)--(a_2.south east);
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        \node[process_v2, keep_middle, after_arrow] at (a_1.south -| ev.center) (ev_1) {
        ...
        \node[process_v2, keep_middle, after_arrow] at (a_2.south -| v.center) (v_1) {
            verify that $V = V'$
            };
