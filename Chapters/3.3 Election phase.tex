...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        \node[title_3, above, anchor=north east] (v) {
            \textbf{Voter $\mathcal{V}_i$}};
        \node[title_3, text width=160, right=of v] (ev) {
            \textbf{External Verifier $\mathcal{X}$}};
        \node[title_3, text width=186, right=of ev] (dbb) {
            \textbf{Digital Ballot Box $\mathcal{D}$}};
        ...
        \node[internal_3, text width=160, below=of ev] (ev_ik) {
            no internal knowledge
            };
        \node[internal_3, text width=186, below=of dbb] (dbb_ik) {
            internal knowledge: $x_\mathcal{D}$, $\boldsymbol{b} = \{ b_1, ..., b_{k-1} \}$, \\
            $\{ b_\mathrm{vs}, b_\mathrm{vec}, b_\mathrm{sec}, b_\mathrm{bc} \} \in \boldsymbol{b}$, $\boldsymbol{b}^{b_\mathrm{bc}} = \{ b_\mathrm{vts} \}$
            };
        
        % All content
        \node[arrow_v2, towards_right, between={v.center}{ev.center}] at (dbb_ik.south -| v.center) (a_1) {
            address of $b_\mathrm{vts}$
            };
        \node[arrow_v2, towards_right, between={ev.center}{dbb.center}, after_arrow] at (a_1.north -| ev.center) (a_2) {
            address of $b_\mathrm{vts}$
            };
        \node[process_3, keep_middle, after_arrow] at (a_2.south -| dbb.center) (dbb_1) {
            $\alpha_\mathrm{vts} \gets \alpha_\mathrm{cnf} \cup \{ b_\mathrm{vs}, b_\mathrm{vec}, b_\mathrm{sec}, b_\mathrm{bc}, b_\mathrm{vts} \}$
            };
        \node[arrow_v2, towards_left, between={ev.center}{dbb.center}] at (dbb_1.south -| dbb.center) (a_3) {
            $\alpha_\mathrm{vts} = \alpha_\mathrm{cnf} \cup \{ b_\mathrm{vs}, b_\mathrm{vec}, b_\mathrm{sec}, b_\mathrm{bc}, b_\mathrm{vts} \}$
            };
        \node[process_3, keep_middle, after_arrow] at (a_3.south -| ev.center) (ev_1) {
            ...
            verify $\mathsf{AncestryVer}(\alpha_\mathrm{vts}, \perp)$ and $\mathsf{ItemVer}(b_j, Y_\mathcal{W})$ for each $b_j \in \alpha_\mathrm{vts}$, \\
            where $\mathcal{W} \in \{ \mathcal{D}, \mathcal{E}, \mathcal{A}, \mathcal{V}_i \}$ according to rules form \cref{app: bulletin board item types}
            };
        \node[arrow_v2, towards_left, between={v.center}{ev.center}] at (ev_1.south -| ev.center) (a_4) {
            "ballot found"
            };
        \node[process_3, keep_left, after_arrow] at (a_4.south -| v.west) (v_1) {
            $m_\mathrm{sr} \gets $ "spoil request", $c_\mathrm{sr} \gets \perp$, $p_\mathrm{sr} \gets$ address of $b_\mathrm{bc}$
            };
        \node[banner_v2, keep_left, after_arrow, between={v.west}{dbb.east}] at (v_1.south -| v.west) (b_1) {
            $\mathcal{V}_i$ and $\mathcal{D}$ perform protocol \ref{fig: write item on the bulletin board protocol} to write $b_\mathrm{sr}$ as the $k^\mathrm{th}$ item of $\boldsymbol{b}$ \\
        ...
        \node[arrow_v2, towards_left, between={ev.center}{dbb.center}] at (b_1.south -| dbb.center) (a_5) {
            $b_\mathrm{sr}$
            };
        \node[process_3, keep_left, after_arrow] at (a_5.south -| ev.west) (ev_2) {
            $h_\mathrm{bc} \gets$ the address of $b_\mathrm{bc}$ \\
            verify $\mathsf{AncestryVer}(\{ b_\mathrm{sr} \}, h_\mathrm{bc})$ and $\mathsf{ItemVer}(b_\mathrm{sr}, Y_i)$ then: \\ [4pt]
        ...
        \node[banner_v2, keep_left, after_arrow, between={ev.west}{dbb.east}] at (ev_2.south -| ev.west) (b_2) {
            $\mathcal{X}$ and $\mathcal{D}$ perform protocol \ref{fig: write item on the bulletin board protocol} to write $b_\mathrm{v}$ as the second item of the hidden track $\boldsymbol{b}^{b_\mathrm{bc}}$ \\
        ...
        \draw[dotted] (dbb_ik.south -| v.center)--(v_1.north -| v.center);
        \draw[dotted] (v_1.south -| v.center)--(b_1.north -| v.center);
        \draw[dotted] (b_1.south -| v.center)--(bottom.south -| v.center);
        % \draw[dotted] (b_1.south -| v.center)--(b_2.north -| v.center);
        % \draw[dotted] (b_2.south -| v.center)--(bottom.south -| v.center);
        
        \draw[dotted] (a_1.south -| ev.center)--(ev_1.north -| ev.center);
        \draw[dotted] (ev_1.south -| ev.center)--(a_4.south east);
        \draw[dotted] (a_5.south west)--(ev_2.north -| ev.center);
        \draw[dotted] (ev_2.south -| ev.center)--(b_2.north -| ev.center);
        \draw[dotted] (b_2.south -| ev.center)--(bottom.south -| ev.center);
        
        \draw[dotted] (a_2.south east)--(dbb_1.north -| dbb.center);
        \draw[dotted] (dbb_1.south -| dbb.center)--(a_3.south east);
        \draw[dotted] (b_1.south -| dbb.center)--(a_5.south east);
        \draw[dotted] (b_2.south -| dbb.center)--(bottom.south -| dbb.center);
        }
    \end{tikzpicture}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        \node[internal_3, below=of ev] (ev_ik) {
            internal knowledge: $x_\mathcal{X}$, $b_\mathrm{v}$
            };
        \node[internal_3, below=of dbb] (dbb_ik) {
            internal knowledge: $x_\mathcal{D}$, $Y_\mathcal{X}$, $r_\mathrm{d}$, $s_\mathrm{d}$, \\
            $\boldsymbol{b}^{b_\mathrm{bc}} = \{ b_\mathrm{vts}, b_\mathrm{v} \}$
            };
        
        % All content
        \node[arrow_v2, first, towards_left, between={v.center}{ev.center}] at (v_ik.south -| ev.center) (a_1) {
            $h_\mathrm{v} = $ address of $b_\mathrm{v}$
            };
        \node[arrow_v2, towards_left, between={v.center}{dbb.center}] at (a_1.south -| dbb.center) (a_2) {
            $b_\mathrm{v}$
            };
        \node[process_3, keep_left, after_arrow] at (a_2.south -| v.west) (v_1) {
        ...
        \node[banner_v2, keep_left, after_arrow, between={v.west}{dbb.east}] at (v_1.south -| v.west) (b_1) {
            $\mathcal{V}_i$ and $\mathcal{D}$ perform protocol \ref{fig: write item on the bulletin board protocol} to write $b_\mathrm{vco}$ as third item of the hiddne track $\boldsymbol{b}^{b_\mathrm{bc}}$ \\
        ...
        \node[process_v2, keep_right, after_arrow] at (b_1.south east) (dbb_1) {
            ...
            \scriptsize perform protocol \ref{fig: write item on the bulletin board protocol} to write $b_\mathrm{sco}$ as the forth item on the \\ [-2pt]
        ...
        \node[arrow_v2, towards_left, between={v.center}{dbb.center}] at (dbb_1.south -| dbb.center) (a_3) {
            $b_\mathrm{vco}$, $b_\mathrm{sco}$
            };
        \node[process_v2, keep_left, after_arrow] at (a_3.south -| v.west) (v_2) {
        ...
        \draw[dotted] (v_ik.south -| ev.center)--(a_1.south east);
        
        \draw[dotted] (dbb_ik.south -| dbb.center)--(a_2.south east);
        \draw[dotted] (b_1.south -| dbb.center)--(dbb_1.north -| dbb.center);
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed, node distance=0,
        ...
        \node[internal_3, below=of dbb] (dbb_ik) {
            ...
            $\boldsymbol{b}^{b_\mathrm{bc}} = \{ b_\mathrm{vts}, b_\mathrm{v}, b_\mathrm{vco}, b_\mathrm{sco} \}$
            };
        
        % All content
        \node[arrow_v2, first, towards_left, between={ev.center}{dbb.center}, anchor=north west] at (dbb_ik.south -| ev.center) (a_1) {
            $b_\mathrm{vco}$, $b_\mathrm{sco}$
            };
        \node[process_3, keep_middle, after_arrow] at (a_1.south -| ev.center) (ev_1) {
            ...
            $d_\mathrm{v} = $ content of $b_\mathrm{vco}$, $d_\mathrm{d} = $ content of $b_\mathrm{sco}$ \\
            $c_\mathrm{v} = $ content of $b_\mathrm{vec}$, $c_\mathrm{d} = $ content of $b_\mathrm{sec}$ \\
        ...
        \node[arrow_v2, towards_left, between={v.center}{ev.center}] at (ev_1.south -| ev.center) (a_2) {
            $V'$
            };
        ...
        \draw[dotted] (a_1.south west)--(ev_1.north -| ev.center);
        \draw[dotted] (ev_1.south -| ev.center)--(a_2.south -| ev.center);
        
        \draw[dotted] (dbb_ik.south -| dbb.center)--(a_1.south east);
        }
    \end{tikzpicture}
