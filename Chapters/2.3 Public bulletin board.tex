...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[framed,
        ...
        % All content
        \node[block, first, keep_left] at (w_ik.south -| w.west) (w_1) {
            $\sigma_i \gets \mathsf{Sign}(x_\mathcal{W}; m_i || c_i || p_i)$
            };
        \node[arrow, towards_right, after_arrow, between={w.center}{dbb.center}, anchor=south west] at (w_1.south -| w.center) (a_1) {
        ...
        \node[arrow, towards_left, after_arrow, between={w.center}{dbb.center}, anchor=south east] at (dbb.center |- dbb_1.south) (a_2) {
            $\rho_i$, $t_i$, $h'_i$, $h_i$ \hspace{70pt}
            };
        \node[block, keep_left, after_arrow] at (a_2.south -| w.west) (w_2) {
